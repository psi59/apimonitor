...
func (_m *Repository) Create(tx rsdb.Connection, src rsmodel.ValidatedObject) error {
...
func (_m *Repository) CreateTable(tx rsdb.Connection) error {
	ret := _m.Called(tx)
...
func (_m *Repository) DeleteById(tx rsdb.Connection, id rsmodel.ValidatedObject) error {
	ret := _m.Called(tx, id)
...
func (_m *Repository) FirstOrCreate(tx rsdb.Connection, src rsmodel.ValidatedObject) error {
	ret := _m.Called(tx, src)
...
func (_m *Repository) GetById(tx rsdb.Connection, id rsmodel.ValidatedObject) error {
	ret := _m.Called(tx, id)
...
func (_m *Repository) List(tx rsdb.Connection, items interface{}, filter rsdb.ListFilter, orders rsdb.Orders) (int, error) {
...
func (_m *Repository) Patch(tx rsdb.Connection, src rsmodel.ValidatedObject, data rsmodel.ValidatedObject) error {
...
func (_m *Repository) Save(tx rsdb.Connection, src rsmodel.ValidatedObject) error {
	ret := _m.Called(tx, src)
