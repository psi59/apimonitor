...
func (_m *Context) Language() string {
	ret := _m.Called()
...
// QueryParamInt64 provides a mock function with given fields: name, defaultInt
func (_m *Context) QueryParamInt64(name string, defaultInt int64) (int64, error) {
	ret := _m.Called(name, defaultInt)

	var r0 int64
	if rf, ok := ret.Get(0).(func(string, int64) int64); ok {
		r0 = rf(name, defaultInt)
	} else {
		r0 = ret.Get(0).(int64)
	}
